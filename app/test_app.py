...
def test_add_molecule(client):
    molecule = {
        '4': {'smiles': '[Na+].[Cl-]', 'molecule_formula': 'NaCl', 'molecule_weight': 58},  # noqa: E501
    }
...
expected_response_molecule = {'smiles': 'CCO', 'molecule_formula': 'C2H5OH', 'molecule_weight': 25}  # noqa: E501
...
@pytest.mark.parametrize(
        ...
        [
            ('1', 200, expected_response_molecule),
            ('10', 404, expected_response_error),
        ],
)
...
def test_update_molecule(
    ...
    molecule = {'smiles': 'CCO', 'molecule_formula': 'C2H5OH', 'molecule_weight': 27}  # noqa: E501
...
def test_substructure_search_molecules(
        client,
        status_code,
        substructure_smiles,
        expected_response,
